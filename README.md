...
- Eldtemplets skatt ger fem rupees och Eldsvärdet en gång. Svärdet tas på direkt och den stora porten i Vulkanens inre öppnas. Eldskölden delas inte längre ut här; den planeras som belöning för miniuppgiften i nästa fas. Befintlig utrustning finns kvar i väskan.
...
`src/game/minibosses/` skiljer definitioner och sparad fasprogression från rena tvåtalspusselregler och Three.js-presentationen. `VolcanoArea` placerar mötet och förmedlar spelarens position; store samordnar interaktioner, faser och belöningar. Siffrorna är geometri från Three.js medföljande teckensnitt, utan externa hämtningar eller texturer. Sparversion 16 använder samma localStorage-nyckel som tidigare; äldre och ogiltiga sparningar börjar om.
