...
`src/game/minibosses/` skiljer definitioner och sparad fasprogression från rena tvåtalspusselregler och Three.js-presentationen. `VolcanoArea` placerar mötet och förmedlar spelarens position; store samordnar interaktioner, faser och belöningar. Siffrorna är geometri från Three.js medföljande teckensnitt, utan externa hämtningar eller texturer. Sparversion 15 använder samma localStorage-nyckel som tidigare; äldre och ogiltiga sparningar börjar om.
