...
- Prefer tests that assert externally observable behavior and results rather than implementation details. Do not export internal constants or helpers solely to test them when the same requirement can be verified through public behavior.
